/**
 * Cloud Tab — Cloud Storage within the tab navigator
 * Wraps the existing Cloud Storage screen for tab-based navigation.
 */
...
export default function CloudTab() {
    ...
    return (
        <ScreenErrorBoundary screenName="Cloud Tab">
            <SafeAreaView style={styles.container} edges={['top']}>
                <ScrollView
